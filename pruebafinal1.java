        ...
        try {
            ...
            if (privateKeyFile.exists() && publicKeyFile.exists()) {
                ...
                try {
                    ...
                    // Mostrar mensaje de éxito y abrir la ventana de "prueba2"
                    JOptionPane.showMessageDialog(null, "Acceso concedido", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                    
                    // Crear instancia de la clase prueba2 y mostrar la ventana de lista de archivos
                    prueba2 fileListApp = new prueba2();
                    fileListApp.showFileListWindow();
